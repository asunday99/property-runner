...
# Prefix demo HTML classes that collide
...
with open("index_beta.html", "w", encoding="utf-8") as f:
    f.write(base)
print("Built new index_beta.html successfully")
