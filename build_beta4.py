...
end_idx = demo.find('<!-- 2. 투자자별 자산 탭 -->')
if end_idx == -1: end_idx = demo.find('<!-- 2. ں ڻ  -->') # handle encoding issue
if end_idx == -1: print("Warning: could not find end of tab-dashboard")

# Instead of relying on Korean comments, let's parse matching divs
open_divs = 0
end_div_idx = -1
...
# Make JS safe
js1 = js1.replace("window.onload = function() {", "function initDashboard() {")
